...
for slice_i = 1 : slice_num 
    ...
    img_start_gfp = double(imread([ztack_image_file_location 'round1\max_' file_name_qianzhui '_round11_GFP-only-3_s'  num2str(temp_slice_stage(4,1))   '.ome.tif'  ]));
	...
	for i1 = 2:length(temp_slice_stage(1,:))
        ...
        img_next_gfp = double(imread([ztack_image_file_location 'round1\max_' file_name_qianzhui '_round11_GFP-only-3_s'  num2str(temp_slice_stage(4,i1))   '.ome.tif'  ]));
	...
	for i1 = 1:length(temp_slice_stage(1,:))
        ...
        img_next_gfp = double(imread([ztack_image_file_location 'round1\max_' file_name_qianzhui '_round11_GFP-only-3_s'  num2str(temp_slice_stage(i2,i1))   '.ome.tif'  ]));
    ...
    imwrite(uint16(big_slice_image),[ file_output_location 'slice_'  num2str(slice_i)  'stitch_gfp.tif' ])
