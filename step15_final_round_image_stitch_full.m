...
for slice_i = 1 : slice_num 
    ...
    img_start = double(imread([ztack_image_file_location 'round5\max_' file_name_qianzhui '_round51_DAPI_s'  num2str(temp_slice_stage(4,1))   '.ome.tif'  ]));
	...
	for i1 = 2:length(temp_slice_stage(1,:))
        ...
        img_next = double(imread([ztack_image_file_location 'round5\max_' file_name_qianzhui '_round51_DAPI_s'  num2str(temp_slice_stage(4,i1))   '.ome.tif'  ]));  
	...
	for i1 = 1:length(temp_slice_stage(1,:))
        ...
        img_start = double(imread([ztack_image_file_location 'round5\max_' file_name_qianzhui '_round51_DAPI_s'  num2str(temp_slice_stage(i2+1,i1))   '.ome.tif'  ]));
        img_next = double(imread([ztack_image_file_location 'round5\max_' file_name_qianzhui '_round51_DAPI_s'  num2str(temp_slice_stage(i2,i1))   '.ome.tif'  ]));
    ...
    imwrite(uint16(big_slice_image),[ file_output_location 'slice_'  num2str(slice_i)  'stitch_gfp_round5_full.tif' ])
